...
import { FaTachometerAlt, FaUserPlus, FaCogs, FaEnvelope, FaMoneyCheckAlt, FaClipboardList } from 'react-icons/fa';
  ...
  return (
    <div className={styles.sidebar}>
      <ul className={styles.sidebarMenu}>
        ...
        <li className={styles.sidebarItem}>
          <NavLink to="/messages" activeClassName={styles.active} className={styles.link}>
            <FaEnvelope className={styles.icon} title="Messages" />
          </NavLink>
        </li>
        <li className={styles.sidebarItem}>
          <NavLink to="/attendance" activeClassName={styles.active} className={styles.link}>
            <FaClipboardList className={styles.icon} title="Attendance" />
          </NavLink>
        </li>
        <li className={styles.sidebarItem}>
          <NavLink to="/payroll" activeClassName={styles.active} className={styles.link}>
